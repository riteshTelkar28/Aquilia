  ...
  <>
     <div className="w-full bg-[#172933]  h-[420px] grid grid-cols-4 gap-4">
      ...
      <div className=" pt-[50px] rounded  text-left pl-[120px] ">
        ...
        <p className='text-base/[24px]'>It is a long established fact that a reader will be distracted by the readable content of a page when looking at</p>
      ...
      <div className=" rounded  text-left pt-[50px] ml-[6px] mr-[71px] ">
         ...
         <div className='text-left gap-3 leading-10'>
          <div className='flex items-center text-[16px]'><TfiEmail size={20}/> &nbsp; Email: Aquila@gmail.com</div>
      ...
      <div className=" rounded  text-left pt-[50px] mr-[120px]">
        <h1 className='text-2xl font-bold  hover:text-[#E26D5A]'>Subscribe Us</h1>
        <br />
        <p className='text-[20px] '>Stay updated with the latest listings and rental tips.</p>
        <br />
        <input type="email" placeholder='Email' className='border-[#E26D5A] border text-[#E26D5A] w-[275px] h-[48px] rounded-[47px] '/>
        <br />
        <br />
